...
* **In-Office or "Back Office"**
  ...
  * _<mark class="yellow-bg">The</mark>_ [_<mark class="yellow-bg">Assessment 1: The Turn-Key Solution</mark>_](../partners/partner-assessments/the-turn-key-solution.md) _<mark class="yellow-bg">and</mark>_ [_<mark class="yellow-bg">Assessment 3: The Custom Software Development Kit</mark>_](../partners/partner-assessments/the-custom-software-development-kit.md) _<mark class="yellow-bg">are examples of solutions that could be run in this kind of setting.</mark>_
* **Data Center**
  ...
  * _<mark class="yellow-bg">The</mark>_ [_<mark class="yellow-bg">Assessment 2: The Open Platform</mark>_](../partners/partner-assessments/the-open-platform.md) _<mark class="yellow-bg">is an example of a solution that could be run in this kind of setting.</mark>_
...
<mark class="yellow-bg">The</mark> [<mark class="yellow-bg">Assessment 4: The Cloud SaaS</mark>](../partners/partner-assessments/the-cloud-software-as-a-service.md) <mark class="yellow-bg">is an example of a solution that is offered in this way.</mark>
