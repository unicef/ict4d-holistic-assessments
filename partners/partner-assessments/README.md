...
{% hint style="success" %}
Most relevant for 💭 [Visionaries](../../get-started.md#visionaries), 🔥 [Advisors](../../get-started.md#advisors) and 🔍 [Technical Evaluators](../../get-started.md#technical-evaluators)
{% endhint %}
...
### <mark class="purple">Learn more about each partner assessment on the following pages:</mark>&#x20;
